...
public:
    METHOD_LIST_BEGIN
        ...
        ADD_METHOD_TO(ZoneController::optionsSearch, "/api/zones/search", Options);
    METHOD_LIST_END
    ...
    void optionsSearch(const HttpRequestPtr& req, std::function<void (const HttpResponsePtr &)> &&callback);
};